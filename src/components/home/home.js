                ...
                <div id="home">
                    <div id="show_case">
                            <div id="bg_1" className={classes.bg_showcase}>
                                <Button component={Link} to={`/client/Womens`} className={classes.button_Base}>
                            ...
                            <div  className={classes.under_side_text}>
                                    ...
                                    <Button component={Link} to={`/client/Womens`} variant="contained" color="primary" classes={{root: classes.button}}>Explore</Button>  
                            </div>
                            <div id="bg_2" className={classes.bg_showcase}>
                                <Button component={Link} to={`/client/kids`}  className={classes.button_Base}>
                                <div className={classes.left_side_text}>
                            ...
                            <div  className={classes.under_side_text}>
                                    ...
                                    <Button component={Link} to={`/client/Kids`} variant="contained" color="primary" classes={{root: classes.button}}>Explore</Button>  
                            </div>
                            <div id="bg_3" className={classes.bg_showcase}>
                                <Button component={Link} to={`/client/Sale`} className={classes.button_Base}>
                                <div className={classes.left_side_text}>
                            ...
                            <div  className={classes.under_side_text}>
                                    ...
                                    <Button component={Link} to={`/client/Sale`} variant="contained" color="primary" classes={{root: classes.button}}>Explore</Button>  
                            </div>
